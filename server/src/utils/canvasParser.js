 ...
 * @param {string} textContent - Raw text content from BotDojo response
 ...
 * @param {string} iframeString - iframe HTML string
 * @returns {Object|null} Product object or null
 */
function extractProductFromIframe(iframeString) {
 ...
 * @param {string} markdownString - Markdown link string
 * @returns {Object|null} Product object or null
 */
function extractProductFromMarkdown(markdownString) {
 ...
 * @returns {Object|null} Product object or null
 */
function extractProductFromCanvasData(canvasData) {
  if (canvasData.url) {
...
module.exports = {
  parseCanvasDataForStructuredContent,
  cleanTextContent
};
