// Image URL utilities for normalizing Magento media paths and selecting best image
...
function normalizeImageUrl(rawUrl, base) {
...
function pickBestImageUrl(product, base) {
