        ...
        <div className="flex flex-col h-screen bg-[#FDFDFC] dark:bg-[#0D1117] font-sans transition-colors duration-300 ease-in-out">
          ...
          <div className="px-6 py-4 transition-colors duration-300 ease-in-out">
            <div className="flex justify-between items-center max-w-4xl mx-auto">
              ...
              onDebugModeChange={(debugMode) => dispatch({ type: 'SET_DEBUG_MODE', payload: debugMode })}
                  onNewChat={handleNewChat}
              showContentTester={state.showContentTester}
              onContentTesterToggle={(show) => dispatch({ type: 'SET_SHOW_CONTENT_TESTER', payload: show })}
                />
              </div>
            </div>
          </div>
